    ...
    while True:
        for event in pygame.event.get():
            ...
            # If the user presses space or up key, start the game for them
                ...
                #GAME_SOUNDS['Caballero - Ofshane.mp3'].play()
...
def mainGame():
    ...
    playerFlapAccv = -11  # velocity while flapping
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Roptor by Mahir')
    ...
    #GAME_SOUNDS['Caballero - Ofshane.mp3']= pygame.mixer.Sound('audio\Caballero - Ofshane.mp3')
